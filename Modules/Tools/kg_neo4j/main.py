...
NODE_TYPES = [
    ...
    "Endpoint", "Parameter", "CVE", "Vulnerability", "Exploit",
    "Credential", "Hash", "Session", "User", "Group", "Computer",
    "Certificate", "Cookie", "Header", "Finding", "AttackPath",
    "CWE", "CAPEC", "MITRE", "CloudResource", "Container", "Registry",
    "Secret", "Config", "LogEntry"
]
