"""
medusa/core/engagement.py — Engagement schema, validation, and session persistence.
...
DEFAULT_SCHEMA = {
    ...
    "findings": [],
    "credentials_file": "medusa_agent/credentials.json",
    "notes_file": "medusa_agent/.notes",
    "stats": {
        "requests_sent": 0,
