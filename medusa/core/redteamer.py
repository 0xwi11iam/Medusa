...
Support modules extracted for maintainability:
  medusa/core/red/config_loader.py   — config.json / .env management
  medusa/core/red/llm_client.py      — async LLM wrapper with timeout
  medusa/core/red/session_control.py — runtime commands (/report, /state, etc.)
