...
class TestFuguImports:
    ...
    def test_run_fugu_importable_no_broken_references(self):
        ...
        The legacy version imported `medusa.redteamer` (nonexistent) and
        `medusa.supervisor` (nonexistent) — this test loads the function
    ...
    def test_roles_complete(self):
        ...
        for role in ["recon", "exploit", "escalate", "persist", "lateral", "report"]:
            ...
            assert "prompt_prefix" in medusa.fugu.ROLES[role]
