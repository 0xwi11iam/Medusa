...
from medusa.kb import compile_kb, kb_diff, read_doc
from medusa.tools import cve_mirror, kb_tools
from medusa.tools.wordlist_mutator import cewl_words, extract_words, mutate_wordlist
...
class TestMutateWordlist:
    def test_expansion(self, tmp_path, monkeypatch):
        from medusa.tools import wordlist_mutator as wm
