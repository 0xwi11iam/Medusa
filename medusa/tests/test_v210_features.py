...
class TestNotify:
    ...
    def test_no_config(self):
        ...
        assert notify.send("t", "m", config={}) == ["notify: no channels configured (medusa/notify.json)"]
...
class TestRules:
    def test_validate_good_and_bad(self, tmp_path):
        from medusa.tools.governance import validate_rules
    ...
    def test_match_rules(self, tmp_path):
        from medusa.tools.governance import match_rules
...
class TestPolicy:
    def test_no_policy_file_allows_everything(self, tmp_path, monkeypatch):
        from medusa.tools import governance
    ...
    def test_policy_file_enforces_scopes(self, tmp_path, monkeypatch):
        from medusa.tools import governance
        from medusa.tools.governance import check_policy, load_policy
    ...
    def test_scope_exempt_intel_tools(self):
        from medusa.tools.governance import _POLICY_DEFAULT, check_policy
    ...
    def test_route_tool_enforces_policy(self, monkeypatch, tmp_path):
        from medusa.tools import dispatch, governance
    ...
    def test_lint_bad_policy(self, tmp_path):
        from medusa.tools.governance import validate_policy
...
class TestModuleSdk:
    def test_scaffold_and_validate(self, tmp_path):
        from medusa.tools.module_sdk import scaffold_module, validate_module
    ...
    def test_duplicate_scaffold_rejected(self, tmp_path):
        from medusa.tools.module_sdk import scaffold_module
...
class TestCampaign:
    ...
    def test_unreachable_lab(self):
        from medusa.tools.housekeeping import run_campaign
...
class TestWatchLines:
    def test_scoring_lines(self):
        from medusa.tools.housekeeping import watch_lines
...
class TestReconHook:
    ...
    def test_no_leads_when_kb_missing(self, monkeypatch):
        ...
        import medusa.tools.recon as recon_mod
