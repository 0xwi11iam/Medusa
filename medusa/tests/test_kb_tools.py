...
from medusa.kb import compile_kb
from medusa.tools import kb_tools
...
class TestExtractPayloads:
    def test_extracts_code_block(self, kb_env):
        ...
        files = list((kb_env["ws"] / "payloads").glob("kb_*"))
        assert files, out
