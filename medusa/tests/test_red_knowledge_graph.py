"""Tests for the red knowledge graph (medusa/intel/knowledge_graph.py) —
...
from medusa.intel import knowledge_graph as kg
...
class TestResilience:
    ...
    def test_agent_routing_roundtrip(self, kg_file):
        ...
        from medusa.tools.intel import check_knowledge, record_finding
    ...
    def test_record_finding_rejects_bad_type(self):
        from medusa.tools.intel import record_finding
