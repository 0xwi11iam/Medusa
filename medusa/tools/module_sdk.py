"""Module SDK — scaffold and validate Medusa module packs.

`medusa module init <name>` creates Modules/Tools/<name>/ with a working
manifest + implementation + skill doc. `medusa module validate <name>`
checks the manifest schema, imports the implementation, and verifies every
declared tool resolves to a callable with a docstring.
"""
...
MODULES_ROOT = Path(__file__).resolve().parents[2] / "Modules" / "Tools"
