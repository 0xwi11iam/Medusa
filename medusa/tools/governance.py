...
RULES (medusa/detector_rules.json): user-defined regex detectors merged
...
POLICY (medusa/policy.json): engagement guardrails enforced at the
dispatch chokepoint — allowed target scopes, blocked tools, blocked
argument patterns. `medusa policy check` lints both.
"""
...
_POLICY_DEFAULT = {
    "description": "Medusa engagement policy — edit as needed",
