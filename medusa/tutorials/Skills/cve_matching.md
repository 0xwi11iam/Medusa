...
To increase NVD API rate limits, set `nvd_api_key` in the Medusa config (Settings TUI, or config.json). Get a free key at: https://nvd.nist.gov/developers/request-an-api-key
