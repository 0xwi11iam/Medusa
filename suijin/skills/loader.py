...
from suijin.skills.access_control import ACCESS_CONTROL_SKILL_PROMPT
from suijin.skills.blue_forensics import BLUE_FORENSICS_PROMPT
from suijin.skills.blue_incident import BLUE_INCIDENT_PROMPT
from suijin.skills.blue_monitoring import BLUE_MONITORING_PROMPT
from suijin.skills.blue_patching import BLUE_PATCHING_PROMPT

# ── Blue Team skills ──────────────────────────────────────────────────
from suijin.skills.blue_recon import BLUE_RECON_PROMPT
from suijin.skills.cache_poisoning import CACHE_POISONING_SKILL_PROMPT
from suijin.skills.clickjacking import CLICKJACKING_SKILL_PROMPT
from suijin.skills.container_escape import CONTAINER_ESCAPE_SKILL_PROMPT
from suijin.skills.cors import CORS_SKILL_PROMPT
from suijin.skills.crlf_injection import CRLF_SKILL_PROMPT
from suijin.skills.csrf import CSRF_SKILL_PROMPT
from suijin.skills.cve_exploit import CVE_EXPLOIT_SKILL_PROMPT
from suijin.skills.deserialization import DESERIALIZATION_SKILL_PROMPT
from suijin.skills.django import DJANGO_SKILL_PROMPT
from suijin.skills.dns_rebinding import DNS_REBINDING_SKILL_PROMPT
from suijin.skills.dom_clobbering import DOM_CLOBBERING_SKILL_PROMPT
from suijin.skills.email_header import EMAIL_HEADER_SKILL_PROMPT
from suijin.skills.file_upload import FILE_UPLOAD_SKILL_PROMPT
from suijin.skills.graphql_attacks import GRAPHQL_SKILL_PROMPT
from suijin.skills.host_header import HOST_HEADER_SKILL_PROMPT
from suijin.skills.http_smuggling import HTTP_SMUGGLING_SKILL_PROMPT
from suijin.skills.information_disclosure import INFO_DISCLOSURE_SKILL_PROMPT
from suijin.skills.jwt_attacks import JWT_SKILL_PROMPT
from suijin.skills.ldap_injection import LDAP_INJECTION_SKILL_PROMPT
from suijin.skills.linux_privesc import LINUX_PRIVESC_SKILL_PROMPT
from suijin.skills.mass_assignment import MASS_ASSIGNMENT_SKILL_PROMPT
from suijin.skills.nosql_injection import NOSQL_SKILL_PROMPT
from suijin.skills.oauth import OAUTH_SKILL_PROMPT
from suijin.skills.open_redirect import OPEN_REDIRECT_SKILL_PROMPT
from suijin.skills.parameter_pollution import PARAMETER_POLLUTION_SKILL_PROMPT
from suijin.skills.path_traversal import PATH_TRAVERSAL_SKILL_PROMPT
from suijin.skills.post_exploit import POST_EXPLOIT_SKILL_PROMPT
from suijin.skills.prototype_pollution import PROTOTYPE_POLLUTION_SKILL_PROMPT
from suijin.skills.race_condition import RACE_CONDITION_SKILL_PROMPT
from suijin.skills.rce import RCE_SKILL_PROMPT
from suijin.skills.redos import REDOS_SKILL_PROMPT
from suijin.skills.saml import SAML_SKILL_PROMPT
from suijin.skills.soul import SOUL_SKILL_PROMPT
from suijin.skills.spring_boot import SPRING_BOOT_SKILL_PROMPT
from suijin.skills.sql_injection import SQLI_SKILL_PROMPT
from suijin.skills.ssrf import SSRF_SKILL_PROMPT
from suijin.skills.subdomain_takeover import SUBDOMAIN_TAKEOVER_SKILL_PROMPT
from suijin.skills.twofa_bypass import TWOFA_BYPASS_SKILL_PROMPT
from suijin.skills.websocket import WEBSOCKET_SKILL_PROMPT
from suijin.skills.wordpress import WORDPRESS_SKILL_PROMPT
from suijin.skills.xpath_injection import XPATH_INJECTION_SKILL_PROMPT
from suijin.skills.xss import XSS_SKILL_PROMPT

# ── New skills ───────────────────────────────────────────────────────
from suijin.skills.xxe import XXE_SKILL_PROMPT
