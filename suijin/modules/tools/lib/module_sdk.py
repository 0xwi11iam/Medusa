...
`suijin module init <name>` creates Modules/Tools/<name>/ with a working
manifest + implementation + skill doc. `suijin module validate <name>`
...
MODULES_ROOT = Path(__file__).resolve().parents[4] / "Modules" / "Tools"
