...
class PackModule(Module):
    ...
    def start(self, ctx) -> None:
        ...
        for tool_name, fn in _load_tools().items():
            ...
            ctx.register_tool(tool_name, _bridge, description="Set-Cookie security flag audit.", owner="cookieaudit")
            bridged += 1
        ctx.journal.append("cookieaudit", f"{bridged} tool(s) registered")
