"""Suijin WebUI — local-first web dashboard for the operator.

`suijin ui` serves a React dashboard on 127.0.0.1 (bound to loopback only —
...
built frontend lives in suijin/ui/dist/ (committed); sources in webui/.
"""
