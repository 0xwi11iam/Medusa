...
class PackModule(Module):
    ...
    def start(self, ctx) -> None:
        ...
        for tool_name, fn in _load_tools().items():
            ...
            ctx.register_tool(tool_name, _bridge, description="Advanced log parsing and analysis", owner="log_surgeon")
            bridged += 1
        ctx.journal.append("log_surgeon", f"{bridged} tool(s) registered")
