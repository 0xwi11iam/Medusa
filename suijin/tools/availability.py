"""DEPRECATED (v4.1 modularisation): lives at suijin.modules.tools.lib.availability. Lazy shim.
...
_target = _il.import_module("suijin.modules.tools.lib.availability")
