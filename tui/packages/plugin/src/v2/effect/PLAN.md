...
- Effect plugins import `@medusa-ai/plugin/v2/effect`, not `@medusa-ai/core`.
- Public domain values use generated `@medusa-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@medusa-ai/plugin/v2/effect`.
