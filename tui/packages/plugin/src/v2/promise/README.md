...
The Promise plugin API is the async/await equivalent of `@medusa-ai/plugin/v2/effect`. It grants plugins the same two in-process capabilities:
...
```ts
import { define } from "@medusa-ai/plugin/v2/promise"
