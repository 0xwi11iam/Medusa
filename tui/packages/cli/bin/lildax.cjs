...
const cached = path.join(scriptDir, ".medusa-cli")
const platform = { darwin: "darwin", linux: "linux", win32: "windows" }[os.platform()] || os.platform()
const arch = { x64: "x64", arm64: "arm64", arm: "arm" }[os.arch()] || os.arch()
const base = "@medusa-ai/cli-" + platform + "-" + arch
const binary = platform === "windows" ? "medusa-cli.exe" : "medusa-cli"
...
if (!resolved) {
  console.error(
    "It seems that your package manager failed to install the right medusa-cli CLI package. Try manually installing " +
