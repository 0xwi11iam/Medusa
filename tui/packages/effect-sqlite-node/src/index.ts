...
export const TypeId: TypeId = "~@medusa-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@medusa-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@medusa-ai/effect-sqlite-node/NodeSqliteClient")
