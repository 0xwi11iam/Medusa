...
import { ModelV2 } from "@medusa-ai/core/model"
import { SessionV2 } from "@medusa-ai/core/session"
import { Agent } from "@medusa-ai/schema/agent"
import { Location } from "@medusa-ai/schema/location"
import { Model } from "@medusa-ai/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@medusa-ai/schema/prompt"
import { Provider } from "@medusa-ai/schema/provider"
import { Project } from "@medusa-ai/schema/project"
import { ProjectDirectories } from "@medusa-ai/schema/project-directories"
import { PermissionV1 } from "@medusa-ai/schema/permission-v1"
import { Session } from "@medusa-ai/schema/session"
import { SessionInput } from "@medusa-ai/schema/session-input"
import { SessionMessage } from "@medusa-ai/schema/session-message"
import { Workspace } from "@medusa-ai/schema/workspace"
import { Command } from "@medusa-ai/schema/command"
import { Connection } from "@medusa-ai/schema/connection"
import { Credential } from "@medusa-ai/schema/credential"
import { FileSystem } from "@medusa-ai/schema/filesystem"
import { Integration } from "@medusa-ai/schema/integration"
import { LLM } from "@medusa-ai/schema/llm"
import { Permission } from "@medusa-ai/schema/permission"
import { Plugin } from "@medusa-ai/schema/plugin"
import { Pty } from "@medusa-ai/schema/pty"
import { Reference } from "@medusa-ai/schema/reference"
import { SessionTodo } from "@medusa-ai/schema/session-todo"
import { Skill } from "@medusa-ai/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@medusa-ai/schema/schema"
import { ProviderV2 } from "@medusa-ai/core/provider"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@medusa-ai/core/command"),
    import("@medusa-ai/core/integration/connection"),
    import("@medusa-ai/core/credential"),
    import("@medusa-ai/core/filesystem"),
    import("@medusa-ai/core/integration"),
    import("@medusa-ai/core/location"),
    import("@medusa-ai/llm"),
    import("@medusa-ai/core/permission"),
    import("@medusa-ai/core/v1/permission"),
    import("@medusa-ai/core/project/copy"),
    import("@medusa-ai/core/pty"),
    import("@medusa-ai/core/project/schema"),
    import("@medusa-ai/core/reference"),
    import("@medusa-ai/core/session/input"),
    import("@medusa-ai/core/session/message"),
    import("@medusa-ai/core/session/todo"),
    import("@medusa-ai/core/session/prompt"),
    import("@medusa-ai/core/skill"),
    import("@medusa-ai/core/v2-schema"),
    import("@medusa-ai/core/schema"),
    import("@medusa-ai/core/workspace"),
  ])
