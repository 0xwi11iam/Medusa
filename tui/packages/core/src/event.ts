...
import type { Data, Definition, Payload } from "@medusa-ai/schema/event"
...
import { Durable } from "@medusa-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@medusa-ai/schema/event").ID
export type { Data, Definition, Payload } from "@medusa-ai/schema/event"
