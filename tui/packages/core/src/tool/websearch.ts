...
import { ToolFailure } from "@medusa-ai/llm"
...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.MEDUSA_WEBSEARCH_PROVIDER === "exa" || process.env.MEDUSA_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.MEDUSA_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("MEDUSA_EXPERIMENTAL") || truthy("MEDUSA_ENABLE_EXA") || truthy("MEDUSA_EXPERIMENTAL_EXA"),
    enableParallel: truthy("MEDUSA_ENABLE_PARALLEL") || truthy("MEDUSA_EXPERIMENTAL_PARALLEL"),
