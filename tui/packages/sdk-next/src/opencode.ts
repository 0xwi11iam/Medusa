import { OpenCode } from "@medusa-ai/client/effect"
...
import { createEmbeddedRoutes } from "@medusa-ai/server/routes"
...
export class Service extends Context.Service<Service, Interface>()("@medusa-ai/sdk-next/OpenCode") {}
