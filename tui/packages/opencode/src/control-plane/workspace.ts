...
import { EventSequenceTable, EventTable } from "@medusa-ai/core/event/sql"
...
import { WorkspaceEvent } from "@medusa-ai/schema/workspace-event"
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        MEDUSA_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        MEDUSA_WORKSPACE_ID: config.id,
        MEDUSA_EXPERIMENTAL_WORKSPACES: "true",
