...
import { llmClient } from "@medusa-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@medusa-ai/llm"
import { LLMClient } from "@medusa-ai/llm/route"
import type { LLMClientService } from "@medusa-ai/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @medusa-ai/llm. It
