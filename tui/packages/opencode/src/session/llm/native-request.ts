import type { JsonSchema, LLMRequest, ProviderMetadata } from "@medusa-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@medusa-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @medusa-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
