...
import { SkillPlugin } from "@medusa-ai/core/plugin/skill"
import { Permission } from "@/permission"
import { FSUtil } from "@medusa-ai/core/fs-util"
import { Config } from "@/config/config"
import { FrontmatterError } from "@medusa-ai/core/v1/config/error"
import { ConfigMarkdown } from "@/config/markdown"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Glob } from "@medusa-ai/core/util/glob"
...
const MEDUSA_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
...
const CUSTOMIZE_MEDUSA_SKILL_NAME = "customize-opencode"
const CUSTOMIZE_MEDUSA_SKILL_DESCRIPTION =
  "Use ONLY when the user is editing or creating opencode's own configuration: opencode.json, opencode.jsonc, files under .opencode/, or files under ~/.config/opencode/. Also use when creating or fixing opencode agents, subagents, skills, plugins, MCP servers, or permission rules. Do not use for the user's own application code, or for any project that is not configuring opencode itself."
const CUSTOMIZE_MEDUSA_SKILL_BODY = SkillPlugin.CustomizeOpencodeContent
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, MEDUSA_SKILL_PATTERN)
  }
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_MEDUSA_SKILL_NAME] = {
          name: CUSTOMIZE_MEDUSA_SKILL_NAME,
          description: CUSTOMIZE_MEDUSA_SKILL_DESCRIPTION,
          location: "<built-in>",
          content: CUSTOMIZE_MEDUSA_SKILL_BODY,
        }
