...
import { ProjectDirectoryTable, ProjectTable } from "@medusa-ai/core/project/sql"
import { ProjectDirectories } from "@medusa-ai/core/project/directories"
...
import { which } from "@medusa-ai/core/util/which"
...
import { AppProcess } from "@medusa-ai/core/process"
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.MEDUSA_FAKE_VCS)
