...
import type * as SDK from "@medusa-ai/sdk/v2"
...
import { SessionShareTable } from "@medusa-ai/core/share/sql"
...
const disabled = process.env["MEDUSA_DISABLE_SHARE"] === "true" || process.env["MEDUSA_DISABLE_SHARE"] === "1"
