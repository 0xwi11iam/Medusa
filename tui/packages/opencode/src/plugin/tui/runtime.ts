...
import {
  ...
  type TuiSlotPlugin,
  type TuiTheme,
} from "@medusa-ai/plugin/tui"
import path from "path"
import { fileURLToPath } from "url"
import { TuiConfig } from "@/config/tui"
import { AppNodeBuilder } from "@medusa-ai/core/effect/app-node-builder"
import { errorData, errorMessage } from "@medusa-ai/tui/util/error"
...
import { hasTheme, upsertTheme } from "@medusa-ai/tui/context/theme"
import { Global } from "@medusa-ai/core/global"
import { Filesystem } from "@/util/filesystem"
import { Process } from "@/util/process"
import { Flock } from "@medusa-ai/core/util/flock"
import { Flag } from "@medusa-ai/core/flag/flag"
import { internalTuiPlugins, type InternalTuiPlugin } from "./internal"
import type { HostPluginApi, HostSlots } from "@medusa-ai/tui/plugin/slots"
import { ConfigPlugin } from "@/config/plugin"
import { ConfigPluginV1 } from "@medusa-ai/core/v1/config/plugin"
import { createCommandShim } from "@medusa-ai/tui/plugin/command-shim"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Effect } from "effect"
import { createPluginRuntime, type PluginRuntime, type TuiPluginHost } from "@medusa-ai/tui/plugin/runtime"
...
async function load(input: {
  ...
  try {
    ...
    const records = Flag.MEDUSA_PURE ? [] : pluginOrigins
    if (Flag.MEDUSA_PURE && pluginOrigins.length) {
    }
