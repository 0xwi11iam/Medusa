...
import { Hash } from "@medusa-ai/core/util/hash"
...
import { optional } from "@medusa-ai/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@medusa-ai/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
      ...
      Effect.succeed({
        ...
        options: {
          headers: {
            "HTTP-Referer": "https://medusa.ai/",
            "X-Title": "medusa",
            "X-BILLING-INVOKE-ORIGIN": "Medusa",
          },
        },
      }),
    vercel: () =>
