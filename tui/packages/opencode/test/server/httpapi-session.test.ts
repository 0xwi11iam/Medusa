...
const originalWorkspaces = Flag.MEDUSA_EXPERIMENTAL_WORKSPACES
...
afterEach(async () => {
  Flag.MEDUSA_EXPERIMENTAL_WORKSPACES = originalWorkspaces
...
describe("session HttpApi", () => {
  ...
  it.instance(
    ...
    () =>
      Effect.gen(function* () {
        const test = yield* TestInstance
        Flag.MEDUSA_EXPERIMENTAL_WORKSPACES = true
