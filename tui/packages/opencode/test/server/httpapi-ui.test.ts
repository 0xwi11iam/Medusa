  ...
  Effect.gen(function* () {
    ...
    yield* Effect.addFinalizer(() =>
      Effect.sync(() => {
        ...
        restoreEnv("MEDUSA_SERVER_PASSWORD", original.envPassword)
        restoreEnv("MEDUSA_SERVER_USERNAME", original.envUsername)
      }),
    )
  }),
)
      ...
      Layer.provide(
        ConfigProvider.layer(
          ConfigProvider.fromUnknown({
            MEDUSA_SERVER_PASSWORD: input?.password,
            MEDUSA_SERVER_USERNAME: input?.username,
          }),
        ),
      ),
    ),
