...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders MEDUSA_CALLER", () => {
    process.env["MEDUSA_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode MEDUSA_CALLER", () => {
    process.env["MEDUSA_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown MEDUSA_CALLER", () => {
    process.env["MEDUSA_CALLER"] = "unknown"
