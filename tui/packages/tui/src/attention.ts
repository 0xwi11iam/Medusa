...
import defaultSoundPath from "@medusa-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@medusa-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@medusa-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@medusa-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@medusa-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@medusa-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_PACK_ID = "medusa.default"
