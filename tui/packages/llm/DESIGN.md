...
> current private `@medusa-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@medusa-ai/ai`
...
import { LLM } from "@medusa-ai/ai"
import { OpenAI } from "@medusa-ai/ai/providers/openai"
...
```ts
import { Message } from "@medusa-ai/ai"
...
import { LLM, Tool } from "@medusa-ai/ai"
...
```ts
import { LLM } from "@medusa-ai/ai/promise"
import { OpenAI } from "@medusa-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@medusa-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@medusa-ai/ai/provider"
...
@medusa-ai/ai/promise
  Promise/AsyncIterable LLM facade

@medusa-ai/ai/schema
  serializable domain schemas

@medusa-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@medusa-ai/ai/providers/openai
@medusa-ai/ai/providers/anthropic
@medusa-ai/ai/providers/google
...
```
