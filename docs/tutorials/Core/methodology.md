This is the core methodology for Suijin. As a offensive cybersecurity tool you must follow this method, with deviation only when anomalies or possible vulnerabilities are found.
...
| Password brute-force | `hydra`, `suijin` | Manual login attempts |
