...
function TopBar({ onMenu }: { onMenu: () => void }) {
  ...
  return (
    <header className="topbar">
      <button className="hamburger" onClick={onMenu} aria-label="Open navigation">☰</button>
      ...
      <div className="top-right">
        <span className={`badge ${live ? "badge-green" : "badge-grey"}`} title={live ? "SSE stream connected" : "stream down — will retry"}>
          {live ? "● LIVE" : "○ offline"}
        </span>
      </div>
    </header>
